...
const routes: Routes = [
  ...
  { path: 'vp/assess', loadChildren: './assess-batch/assess-batch.module#AssessBatchModule', data: { animation: "AssessBatchPage" }},
  { path: 'vp/reports', loadChildren: './reports/reports.module#ReportsModule', data: { animation: "ReportsPage" }},
